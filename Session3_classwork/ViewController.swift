...
class ViewController: UIViewController {
    ...
    private lazy var viewChild6: UIView = {
        let view = UIView()
    ...
    private lazy var scrollView2: UIScrollView = {
        ...
        view.contentSize = CGSize.init(width: self.view.frame.width, height: 152 + 16)
        view.bounces = false
        view.contentInset = UIEdgeInsets.init(top: 8, left: 10, bottom: 8, right: 10)
